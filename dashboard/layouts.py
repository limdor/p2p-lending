...
def DiversificationReport(investment_raw_dataframe):
    ...
    return dash.html.Div(
        [
            ...
            conditionalDiv(report['originatorStatistics']['investmentOneOriginator']/20,
